...
/* package sudoku-solver-0.1.0.0 */
#ifndef VERSION_sudoku_solver
#define VERSION_sudoku_solver "0.1.0.0"
#endif /* VERSION_sudoku_solver */
#ifndef MIN_VERSION_sudoku_solver
#define MIN_VERSION_sudoku_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "sudoku-solver-0.1.0.0-inplace-sudoku-solver"
